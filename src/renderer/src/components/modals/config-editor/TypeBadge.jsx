// Small pill showing the inferred type of a config value (ON/OFF, INT,
// FLOAT, COLOR, KEY, SELECT, TEXT). Shared by both the schema-driven and
// comment-driven renderers in ConfigEditorModal.
