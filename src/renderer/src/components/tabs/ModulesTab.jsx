...
function ModulesTab({
  ...
  return (
    <div className="flex flex-col gap-2 w-full animate-slide-up">
      {/* Search / Filter / Sort toolbar — always rendered so the Rescan button
          stays reachable even when the library is empty (e.g. after the user
          drops mod files into the mods folder manually). Search / filter / sort
          simply operate on an empty list until mods appear. */}
      ...
      {modules.length === 0 ? (
        /* Empty library — nothing installed yet */
