...
contextBridge.exposeInMainWorld('api', {
  ...
  mods: {
    ...
    backup: () => ipcRenderer.invoke('mods:backup'),
    listBackups: () => ipcRenderer.invoke('mods:list-backups'),
    restoreBackup: (backupPath) => ipcRenderer.invoke('mods:restore-backup', backupPath),
