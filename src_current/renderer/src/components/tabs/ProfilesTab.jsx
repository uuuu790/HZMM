...
import { Save, Plus, CheckCircle, Play, Trash2, RefreshCw, Download, Upload } from 'lucide-react';
    ...
    <div className="flex flex-col gap-4 w-full animate-slide-up duration-500">
      <div className="flex items-center gap-3 mb-2 px-4">
        ...
        <button
          ...
          className="ml-auto flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-full bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:text-[var(--accent-600)] hover:border-[var(--accent-300)] transition-all duration-300 active:scale-95 shadow-sm"
        >
